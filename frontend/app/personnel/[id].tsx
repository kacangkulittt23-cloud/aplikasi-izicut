  ...
  return (
    <View style={styles.container}>
      ...
      <Sheet visible={confirm.open} onClose={() => setConfirm({ open: false })} title="Hapus Entri" testID="confirm-sheet">
        ...
        <Pressable testID="cancel-delete" onPress={() => setConfirm({ open: false })} style={styles.cancelBtn} disabled={deleteLeaveMut.isPending}>
...
function LeaveForm({
  ...
  return (
    <Sheet visible onClose={onClose} title={edit ? "Edit Catatan" : "Tambah Izin / Cuti"} testID="leave-form">
      ...
      <Pressable testID="cancel-leave-button" onPress={onClose} style={styles.cancelBtn} disabled={mut.isPending}>
        <Icon name="ArrowLeft" size={16} color={colors.onSurfaceSecondary} />
        <Text style={styles.cancelText}>Batal</Text>
      </Pressable>
    </Sheet>
...
function PersonForm({ person, onClose, onSaved }: { person: Personnel; onClose: () => void; onSaved: () => void }) {
  ...
  return (
    <Sheet visible onClose={onClose} title="Edit Data Personil" testID="person-form">
      ...
      <Pressable testID="cancel-person-button" onPress={onClose} style={styles.cancelBtn} disabled={mut.isPending}>
        <Icon name="ArrowLeft" size={16} color={colors.onSurfaceSecondary} />
        <Text style={styles.cancelText}>Batal</Text>
      </Pressable>
    </Sheet>
