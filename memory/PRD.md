...
## Changelog (lanjutan dari GitHub)
- 2026-06: Proyek ditarik dari GitHub (public) & dijalankan ulang di environment baru. Backend .env diisi ulang (JWT_SECRET, ADMIN_USERNAME=admin, ADMIN_PASSWORD=Mimika2026!). DB preview kosong (admin perlu upload Excel).
- 2026-06: Dashboard sekarang menampilkan empty-state "Belum ada data personil" + tombol "Buka Panel Admin" saat DB kosong (sebelumnya spinner terus).
- 2026-06: Ditambahkan tombol "Batal" (kembali) di semua form bottom-sheet: Tambah Personil, Ganti Password, Edit Personil, Tambah/Edit Izin, dan konfirmasi Hapus — agar mudah membatalkan tanpa harus mencari tombol X kecil.
